...
// Command Function for Setting DEBUG flags 

static int cmd_dbflags(int nargs, char **args) {
	(void) nargs;
	(void) args;
	// first display the menu	
	showmenu("OS/161 Debug flags", dbflags_menu);

	// then print the current value of dbflags
...
// ASST0 debug flags command implementation
static int cmd_db (int nargs, char **a) {
	// nargs is the number of arguments, char** a is the array of arguments	
